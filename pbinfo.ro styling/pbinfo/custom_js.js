...
chrome.storage.sync.get({pbinfoStyling: true}, (items) => {
  if(!items.pbinfoStyling) return;
  // Nav Bar icons
  document.querySelector('#bara_navigare > div > div.navbar-header > a').innerHTML = `
  ...
  `;
  document.querySelector('#bara_navigare > div > div.navbar-header > a').title = "Acasă";
  ...
  document.querySelector("#navbar > ul.nav.navbar-nav.navbar-right > li:nth-child(1) > a").innerHTML = `
  ...
  `;
  document.querySelector("#navbar > ul.nav.navbar-nav.navbar-right > li:nth-child(1) > a").title = "Profesor";

  document.querySelector("#navbar > ul.nav.navbar-nav.navbar-right > li:nth-child(2) > a").innerHTML = `
  ...
  `;
  document.querySelector("#navbar > ul.nav.navbar-nav.navbar-right > li:nth-child(2) > a").title = "Profil";
  ...
  try {
    document.querySelector("#navbar > ul.nav.navbar-nav.navbar-right > li:nth-child(1) > a[data-target=\"#modal_login\"]").innerHTML = `
    ...
    `;
    document.querySelector("#navbar > ul.nav.navbar-nav.navbar-right > li:nth-child(1) > a[data-target=\"#modal_login\"]").title = "Autentificare";

    document.querySelector("#navbar > ul.nav.navbar-nav.navbar-right > li:nth-child(2) > a[href=\"/?pagina=creare-cont\"]").innerHTML = `
    ...
    `;
    document.querySelector("#navbar > ul.nav.navbar-nav.navbar-right > li:nth-child(2) > a[href=\"/?pagina=creare-cont\"]").title = "Înregistrare";
  } catch {};
});
